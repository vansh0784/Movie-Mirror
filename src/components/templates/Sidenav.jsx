  ...
  return (
   <div className='w-[20%] h-full border-r-2 border-r-zinc-200 p-5 text-white'>
      ...
      <nav className='flex flex-col gap-3  text-zinc-400  text-md  '>
        ...
        <Link className='hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-1 '> <i className="mr-2 ri-fire-line"></i>Trending</Link>
      ...
      <nav className='flex flex-col gap-3  text-zinc-400  text-md   '>
        ...
        <Link className='hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-1 '><i className="ri-information-line mr-2"></i> About</Link>
        <Link className='hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-1 '><i className="ri-customer-service-2-line mr-2"></i> Contact Us</Link>
      </nav>
